                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-sm font-bold text-[#1B2A4A] tracking-tight">
                                CONTAIN'<span className="text-[#2563eb]">A'RISK</span>
                            </span>
                        </div>
                        <p className="text-[12px] text-gray-400 leading-relaxed">
                            AI-powered container risk intelligence for port security and customs operations.
                        </p>
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h4 className="text-[11px] font-bold text-[#1B2A4A] uppercase tracking-[0.12em] mb-4">{category}</h4>
                            <ul className="space-y-2.5">
                                {links.map((link) => (
                                    <li key={link}>
                                        <a href="#" className="text-[13px] text-gray-400 hover:text-[#1B2A4A] transition-colors">
                                            {link}
                                        </a>
                                    </li>
                                ))}

    ...
    <section id="hero" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-32 min-h-screen flex flex-col justify-center">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}
          ...
          Our system does not just predict risk. It builds a full customs intelligence platform that prioritizes
          inspections, detects trade fraud networks, and explains suspicious shipments.
        </motion.p>
